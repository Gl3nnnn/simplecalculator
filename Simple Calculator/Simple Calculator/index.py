...
class Calculator:
    ...
    def create_digit_buttons(self):
        for digit, grid_value in self.digits.items():
            ...
            button.bind("<Enter>", lambda e, btn=button: btn.config(bg=LABEL_COLOR, fg=BACKGROUND_COLOR))
            button.bind("<Leave>", lambda e, btn=button: btn.config(bg=BUTTON_COLOR, fg=LABEL_COLOR))
    ...
    def create_operator_buttons(self):
        ...
        for operator, symbol in self.operations.items():
            ...
            button.bind("<Enter>", lambda e, btn=button: btn.config(bg=LABEL_COLOR, fg=BACKGROUND_COLOR))
            button.bind("<Leave>", lambda e, btn=button: btn.config(bg=OPERATOR_COLOR, fg=LABEL_COLOR))
            i += 1
    ...
    def create_equals_button(self):
        button = tk.Button(self.buttons_frame, text="=", bg=OPERATOR_COLOR, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
